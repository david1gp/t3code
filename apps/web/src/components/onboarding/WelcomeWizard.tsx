      ...
      <Collapsible open={expanded && !!isSignedIn && discoveryReady} onOpenChange={setExpanded}>
        ...
        <CollapsiblePanel keepMounted>
          <div className="px-3 pb-3">
            ...
            <CommandBlock command="npx @adaptive-ds/t3code connect" className="mt-3" />
      ...
      >
        ...
        <Collapsible>
          ...
          <CollapsiblePanel>
            ...
            <CommandBlock command="npx @adaptive-ds/t3code pair" className="mt-2" />
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Start T3 Code first, or run{" "}
              <code className="font-mono">npx @adaptive-ds/t3code serve</code>. Add{" "}
