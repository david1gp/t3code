...
- The access-mode preference hides only the inline `Full access` composer control, not access choices in the compact composer menu or the access behavior.
...
4. [done] Apply access-mode visibility preference to the inline composer control while preserving the compact-menu alternative.
