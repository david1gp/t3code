 ...
 * executable in the sibling `@adaptive-ds/t3code-<platform>-<arch>` package.
 *
...
const executable = join(dirname(require.resolve("@adaptive-ds/t3code-" + process.platform + "-" + process.arch + "/package.json")), executableName);
